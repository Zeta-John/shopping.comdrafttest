...
namespace shoppingcomdraft5.Pages.Roles
{
    ...
    public class ManageModel : PageModel
    {
        ...
        public ManageModel(shoppingcomdraft5.Data.shoppingcomdraft5Context context,
    ...
    public async Task<IActionResult> OnPostAsync(string selectedusername, string selectedrolename)
        {
           ...
           selectedusername);
            ...
            if (roleResult.Succeeded)
            {
                ...
                //After changes
                auditlog.AfterChange = "Gave " + selectedrolename + " role to " + selectedusername;
       ...
       delrolename)
        {
            ...
            if (await _userManager.IsInRoleAsync(user, delrolename))
            {
                ...
                //Audit Action Type
                auditlog.ActionType = "Remove role";
                ...
                //After changes
                auditlog.AfterChange = "Remove " + delrolename + " role from " + delusername;
